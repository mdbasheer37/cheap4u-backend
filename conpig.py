# conpig.py  (keep this filename — it matches your Render deployment)
import os
from datetime import timedelta
from dotenv import load_dotenv

# override=False means Render's real env vars always win over blank .env values
...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = database_url if database_url else 'sqlite:///database.db'
